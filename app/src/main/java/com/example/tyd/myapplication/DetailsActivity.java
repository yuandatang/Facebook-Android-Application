...
public class DetailsActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.favourite){
            if(type.equals("user")) {
                FHomeFragment.user_fav.add(data);
            }
            if(type.equals("place")) {
                FHomeFragment.place_fav.add(data);
            }
            if(type.equals("page")) {
                FHomeFragment.page_fav.add(data);
            }
            if(type.equals("group")) {
                FHomeFragment.group_fav.add(data);
            }
            if(type.equals("event")) {
                FHomeFragment.event_fav.add(data);
            }
        }
